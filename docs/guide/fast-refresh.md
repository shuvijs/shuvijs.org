...
- Anonymous arrow functions like `export default () => <div />;` cause Fast Refresh to not preserve local component state. For large codebases should named component.
  ```javascript
...
- Sometimes you might want to _force_ the state to be reset, and a component to
  ...
  edit.
- You can put `console.log` into the components you edit during
  development.
